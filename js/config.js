export const API_BASE = 'http://127.17.0.1/api/v1/chats';
export const API_TOKEN = 'ragflow-qkFLtyQSa7vfBTMP0tSeGqxAm3FwQ9b6EuCzvJJUGyA';
export const MAX_DEBATE_ROUNDS = 5;

export const AGENTS = {
    general: { id: 'c9fe7e74de3e11f0b40873186f897dd2', name: '通用知识', class: 'c-general', icon: 'fa-brain', roleText: 't-general', sessionId: null },
    ...
    host: { id: '03a24a42e54911f09e2ae5a769207490', name: '主持人', class: 'c-host', icon: 'fa-user-tie', roleText: 't-host', sessionId: null }
};